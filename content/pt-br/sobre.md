...
keywords = ["João Pedro Sconetto", "engenheiro de software", "líder de equipe", "Python", "JavaScript", "React", "Vue", "Docker", "Ansible", "CI/CD", "sistemas de fábrica", "gestão de pessoas", "qualidade de código", "fotografia", "jogos", "corrida"]
readingTime = false
hideComments = false
