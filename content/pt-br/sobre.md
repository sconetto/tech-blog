+++
title = "Sobre mim"
date = "2026-01-02T12:02:31+01:00"
author = "João Pedro Sconetto"
description = "Uma pequena introdução sobre mim"
cover = "/img/me.jpeg"
tags = ["sobre", "engenharia de software", "liderança de equipe", "tecnologia", "desenvolvimento"]
keywords = ["João Pedro Sconetto", "engenheiro de software", "líder de equipe", "Python", "JavaScript", "React", "Vue", "Docker", "Ansible", "CI/CD", "sistemas de fábrica", "gestão de pessoas", "qualidade de código", "Joby Aviation", "fotografia", "jogos", "corrida"]
readingTime = false
hideComments = false
...
- Fotografia 📷 [[Meu Portfólio](https://photos.sconetto.me)]
- Jogos 🎮
- Corrida 🏎️ (F1, Endurance, WRC, Stock Car/DTM)
- Música 🎵 🎸
- Séries, TV e Filmes 🎬
...
Sinta-se à vontade para entrar em contato se quiser colaborar, discutir ideias ou apenas dizer olá! 🚀
